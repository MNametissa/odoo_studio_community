...
import ActionEditor from "odoo_studio_community.ActionEditor";
import bus from "odoo_studio_community.bus";
import ViewEditorManager from "odoo_studio_community.ViewEditorManager";
...
export const ActionEditorMain = Widget.extend({
    ...
    start: function () {
        var self = this;
        var def;
        this.$el.addClass("o_odoo_studio_community_client_action");
    ...
    _editAction: function (action, args) {
        ...
        return this._rpc({
            route: "/odoo_studio_community/edit_action",
            params: {
    ...
    _getStudioViewArch: function (model, view_type, view_id) {
        ...
        core.bus.trigger("clear_cache");
        return this._rpc({
            route: "/odoo_studio_community/get_studio_view_arch",
            params: {
                model: model,
                view_type: view_type,
                view_id: view_id,
    ...
    _isActivityAllowed: function () {
        ...
        return this._rpc({
            route: "/odoo_studio_community/activity_allowed",
            params: {
                model: modelName,
            },
    ...
    _isChatterAllowed: function () {
        ...
        return this._rpc({
            route: "/odoo_studio_community/chatter_allowed",
            params: {
                model: res_model,
            },
    ...
    _writeViewMode: function (view_mode, initial_view_mode) {
        ...
        return def.then(function (result) {
            ...
            return self.do_action("action_odoo_studio_community_action_editor", {
                action: result,
                noEdit: true,
            });
        });
