odoo.define('odoo_studio_community.NewModel', function (require) {
"use strict";
...
const NewModelItem = Widget.extend({
    template: 'odoo_studio_community.NewModel',
    events: {
...
const NewModelDialog = CommonMenuDialog.extend({
    template: 'odoo_studio_community.NewModel.Dialog',
    ...
    async start() {
        await this._super(...arguments);
        this.opened(() => {
            this.$modal.addClass('o_odoo_studio_community_new_model_modal');
            // focus on input
