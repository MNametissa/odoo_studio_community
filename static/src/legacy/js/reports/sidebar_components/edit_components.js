odoo.define('odoo_studio_community.reportEditComponents', function (require) {
"use strict";
...
var Abstract = require('odoo_studio_community.AbstractReportComponent');
...
var LayoutEditable = AbstractEditComponent.extend({
    name: 'layout',
    template : 'odoo_studio_community.ReportLayoutEditable',
    events : _.extend({}, AbstractEditComponent.prototype.events, {
        "change .o_odoo_studio_community_margin>input": "_onMarginInputChange",
        "change .o_odoo_studio_community_width>input": "_onWidthInputChange",
        "click .o_odoo_studio_community_font_size .dropdown-item-text": "_onFontSizeChange",
        "change .o_odoo_studio_community_table_style > select": "_onTableStyleInputChange",
        "click .o_odoo_studio_community_text_decoration button": "_onTextDecorationChange",
        "click .o_odoo_studio_community_text_alignment button": "_onTextAlignmentChange",
        "change .o_odoo_studio_community_classes>input": "_onClassesChange",
        "click .o_odoo_studio_community_colors .o_odoo_studio_community_reset_color": "_onResetColor",
        "click .o_odoo_studio_community_colors .o_odoo_studio_community_custom_color": "_onCustomColor",
    }),
    /**
     * @override
     */
    ...
    renderElement: function() {
        var self = this;
        this._super.apply(this, arguments);
        this.$('.o_odoo_studio_community_background_colorpicker .o_odoo_studio_community_color_palette').append(this._createPalette());
        this.$('.o_odoo_studio_community_background_colorpicker').on("mousedown", 'button[data-color]', function (e) {
            self._onColorChange($(e.currentTarget).data('value').replace('text-', 'bg-'), "background");
        });
        this.$('.o_odoo_studio_community_font_colorpicker .o_odoo_studio_community_color_palette').append(this._createPalette());
        this.$('.o_odoo_studio_community_font_colorpicker').on("mousedown", 'button[data-color]', function (e) {
    ...
    _createPalette: function () {
        ...
        this._groupColors.forEach(function (color) {
            ...
            if (typeof color === 'string') {
                ...
                $row = $('<div class="o_odoo_studio_community_color_row"/>');
    ...
    _onCustomColor: function (e) {
        ...
        colorpicker.on('colorpicker:saved', this, (ev) => {
            ...
            $button.attr('data-value', color);
            $button.css('background-color', color);
            $(e.target).closest('.dropdown-item').find('.o_odoo_studio_community_custom_colors').append($button);
            $button.mousedown();
        });
        colorpicker.open();
    },
...
var TField = AbstractEditComponent.extend({
    name: 'tfield',
    template : 'odoo_studio_community.ReportDirectiveTField',
    selector: '[t-field]',
    /**
     * @override
     */
    ...
    start: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            var $expr = self.$('.o_odoo_studio_community_tfield_fieldexpression');
...
var TIf = AbstractEditComponent.extend({
    name: 'tif',
    template : 'odoo_studio_community.ReportDirectiveTIf',
    selector: '',
    events: _.extend({}, AbstractEditComponent.prototype.events, {
    ...
    start: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            return self.fieldSelector['t-if'].appendTo(self.$('.o_odoo_studio_community_tif_ifexpression'));
        });
    },
...
var TElse = AbstractEditComponent.extend({
    name: 'telse',
    template : 'odoo_studio_community.ReportDirectiveTElse',
    selector: '[t-else]',
    ...
    start: function () {
        var self = this;
        return this._super.apply(this, arguments).then(function () {
            return self.fieldSelector['t-else'].appendTo(self.$('.o_odoo_studio_community_telse_elseexpression'));
        });
    },
    /**
     * @override
...
var TEsc = AbstractEditComponent.extend({
    name: 'tesc',
    template : 'odoo_studio_community.ReportDirectiveTEsc',
    selector: '[t-esc]',
    /**
     * @override
     */
    ...
    start: function () {
        var self = this;
        return this._super.apply(this, arguments).then(function () {
            return self.fieldSelector['t-esc'].appendTo(self.$('.o_odoo_studio_community_tesc_escexpression'));
        });
    },
});
...
var TSet = AbstractEditComponent.extend({
    name: 'tset',
    template : 'odoo_studio_community.ReportDirectiveTSet',
    selector: '[t-set]',
    /**
     * @override
     */
    ...
    start: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            return Promise.all([
                self.fieldSelector['t-set'].appendTo(self.$('.o_odoo_studio_community_tset_setexpression')),
                self.fieldSelector['t-value'].appendTo(self.$('.o_odoo_studio_community_tset_valueexpression'))
            ]);
        });
    },
});
...
var TForeach = AbstractEditComponent.extend({
    name: 'tforeach',
    template : 'odoo_studio_community.ReportDirectiveTForeach',
    ...
    start: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            return Promise.all([
                self.fieldSelector['t-as'].appendTo(self.$('.o_odoo_studio_community_tas_asexpression')),
                self.fieldSelector['t-foreach'].appendTo(self.$('.o_odoo_studio_community_tforeach_foreachexpression'))
            ]);
        });
    },
});
...
var BlockTotal = AbstractEditComponent.extend({
    name: 'blockTotal',
    template : 'odoo_studio_community.BlockTotal',
    ...
    start: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            return Promise.all([
                self.fieldSelector.total_currency_id.appendTo(self.$('.o_odoo_studio_community_report_currency_id')),
                self.fieldSelector.total_amount_untaxed.appendTo(self.$('.o_odoo_studio_community_report_amount_untaxed')),
                self.fieldSelector.total_amount_total.appendTo(self.$('.o_odoo_studio_community_report_amount_total')),
                self.fieldSelector.total_amount_by_groups.appendTo(self.$('.o_odoo_studio_community_report_amount_by_groups'))
            ]);
        });
    },
    /**
...
var Column = AbstractEditComponent.extend({
    name: 'column',
    template : 'odoo_studio_community.ReportColumn',
    ...
    start: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            return Promise.all([
                self.fieldSelector.size.prependTo(self.$('.o_odoo_studio_community_size')),
                self.fieldSelector.offset.prependTo(self.$('.o_odoo_studio_community_offset'))
            ]);
        });
    },
    /**
...
var Text = AbstractEditComponent.extend({
    name: 'text',
    template : 'odoo_studio_community.ReportText',
    ...
    start: function () {
        ...
        return this._super.apply(this, arguments)
            .then(function () {
                return self.fieldSelector.text.appendTo(self.$('.o_odoo_studio_community_text'));
            }).then(function () {
    ...
    _startWysiwygEditor: function () {
        ...
        const options = {
            ...
            resizable: true,
            toolbarTemplate: 'odoo_studio_community.Sidebar.web_editor_toolbar',
...
var Image = LayoutEditable.extend({
    name: 'image',
    template: 'odoo_studio_community.ReportImage',
    selector: 'img',
    /**
     * @override
     */
    ...
    start: function() {
        var self = this;
        return this._super.apply(this, arguments).then(function () {
            return self.fieldSelector.src.appendTo(self.$('.o_odoo_studio_community_source'));
        });
    },
});
...
var Groups = AbstractEditComponent.extend({
    name: 'groups',
    template: 'odoo_studio_community.ReportGroups',
    insertAsLastChildOfPrevious: true,
    /**
     * @override
     */
    ...
    start: function() {
        var self = this;
        return this._super.apply(this, arguments).then(function () {
            return self.fieldSelector.groups.appendTo(self.$('.o_odoo_studio_community_groups'));
        });
    },
});
...
var TOptions = AbstractEditComponent.extend( {
    name: 'toptions',
    template : 'odoo_studio_community.ReportDirectiveTOptions',
    ...
    start: function () {
        ...
        if (this.widget) {
            this.$('.o_odoo_studio_community_toption_widget select').val(this.widget.key);
    ...
    _updateWidgetOptions: function () {
        ...
        this.$('.o_odoo_studio_community_toption_options').remove();
        if (!this.widget || !this.widget.options.length) {
            return;
        }
        var $options = $(qweb.render('odoo_studio_community.ReportDirectiveTOptions.options', this));
        var mountedComponents = [];
        var defs = _.map(this.widget.options, function (option) {
            var $option = $options.find('.o_odoo_studio_community_toption_option_' + self.widget.key + '_' + option.key);
