odoo.define('odoo_studio_community.studio_report_kanban', function (require) {
"use strict";
...
var StudioReportKanbanController = KanbanController.extend({
    ...
    _openReportRecord: function (data) {
        ...
        Promise.resolve(def).then(function (result) {
            ...
            self.do_action('odoo_studio_community.action_edit_report', {
                report: report,
...
var NewReportDialog = Dialog.extend({
    template: 'odoo_studio_community.NewReportDialog',
    events: {
        'click .o_odoo_studio_community_report_layout_item': '_onReportTemplateSelected',
    },
    /**
     * @constructor
     * @param {Widget} parent
    ...
    _createNewReport: function (modelName, layout) {
        return this._rpc({
            route: '/odoo_studio_community/create_new_report',
            params: {
