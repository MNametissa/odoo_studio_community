odoo.define('odoo_studio_community.ReportEditorSidebar', function (require) {
"use strict";
...
var newComponentsRegistry = require('odoo_studio_community.reportNewComponentsRegistry');
var studioUtils = require('odoo_studio_community.utils');
...
var ReportEditorSidebar = Widget.extend(StandaloneFieldManagerMixin, {
    template: 'odoo_studio_community.ReportEditorSidebar',
    events: {
        'change input': '_onChangeReport',
        'click .o_odoo_studio_community_sidebar_header > div:not(.inactive)': '_onTab',
        'click .o_odoo_studio_community_xml_editor': '_onXMLEditor',
        'click .o_odoo_studio_community_parameters': '_onParameters',
        'click .o_odoo_studio_community_remove': '_onRemove',
    },
    /**
     * @constructor
     * @param {Widget} parent
    ...
    _startModeNew: function () {
        var self = this;
        var defs = [];
        var $sidebarContent = this.$('.o_odoo_studio_community_sidebar_content');
        ...
        _.each(newComponentsRegistry.map, function (components, title) {
            ...
            var $componentsContainer = $('<div>', {
                class: 'o_odoo_studio_community_field_type_container',
            });
    ...
    _startModeProperties: function () {
        ...
        var $accordion = this.$('.o_odoo_studio_community_sidebar_content .o_odoo_studio_community_accordion');
        ...
        this.nodes.forEach(function (node) {
            var $accordionSection = $(qweb.render('odoo_studio_community.AccordionSection', {
            ...
            componentsAppendedPromise = Promise.all(renderingProms).then(function () {
                ...
                var $removeButton = $(qweb.render('odoo_studio_community.Sidebar.Remove'));
            ...
            $accordionSection
                ...
                .find('.collapse').on('show.bs.collapse hide.bs.collapse', function (ev) {
                    $(this).parent('.card').toggleClass('o_odoo_studio_community_active', ev.type === 'show');
                });
        });
        ...
        $lastCard.addClass('o_odoo_studio_community_active');
    ...
    _startModeReport: function () {
        ...
        defs.push(many2one.appendTo(this.$('.o_odoo_studio_community_paperformat_id')));
