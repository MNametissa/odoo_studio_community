odoo.define('odoo_studio_community.CommonMenuDialog', function (require) {
"use strict";

const Dialog = require('web.Dialog');
const { ModelConfiguratorDialog } = require('@odoo_studio_community/client_action/model_configurator/model_configurator');
