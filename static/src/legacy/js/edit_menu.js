odoo.define('odoo_studio_community.EditMenu', function (require) {
"use strict";

const CommonMenuDialog = require('odoo_studio_community.CommonMenuDialog');
...
var MenuItem = Widget.extend({
    template: 'odoo_studio_community.EditMenu.MenuItem',
    events: {
...
var EditMenuDialog = Dialog.extend({
    template: 'odoo_studio_community.EditMenu.Dialog',
    ...
    init: function (parent, menu_data, current_primary_menu, scrollToBottom) {
        var options = {
            title: _t('Edit Menu'),
            size: 'medium',
            dialogClass: 'o_odoo_studio_community_edit_menu_modal',
            buttons: [{
                text: _t("Confirm"),
                classes: 'btn-primary',
...
const NewMenuDialog = CommonMenuDialog.extend({
    template: 'odoo_studio_community.EditMenu.Dialog.New',
    ...
    start: function () {
        ...
        this.opened().then(function () {
            self.$modal.addClass('o_odoo_studio_community_add_menu_modal');
            // focus on input
    ...
    _doSave(menuName) {
        ...
        return this._rpc({
            route: '/odoo_studio_community/create_new_menu',
            params: {
                menu_name: menuName,
                model_id: modelID,
