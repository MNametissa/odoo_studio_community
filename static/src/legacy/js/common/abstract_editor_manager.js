odoo.define('odoo_studio_community.AbstractEditorManager', function (require) {
"use strict";
...
var XMLEditor = require('odoo_studio_community.XMLEditor');
...
var AbstractEditorManager = Widget.extend({
    className: 'o_odoo_studio_community_editor_manager',
    custom_events: {
        ...
        return this._super.apply(this, arguments).then(function () {
            return self._instantiateEditor().then(function (editor) {
                ...
                var $editorFragment = $('<div>', {
                    class: 'o_odoo_studio_community_view_renderer',
                });
                self.editor = editor;
    ...
    _updateSidebar: function (mode, params) {
        ...
        if  (this.sidebar.$el) {
            ...
            // TODO: scroll top is calculated to 'o_odoo_studio_community_sidebar_content'
