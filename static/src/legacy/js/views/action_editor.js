odoo.define('odoo_studio_community.ActionEditor', function (require) {
"use strict";

var Widget = require('web.Widget');

var ActionEditorSidebar = require('odoo_studio_community.ActionEditorSidebar');
var ActionEditorView = require('odoo_studio_community.ActionEditorView');

const { SUPPORTED_VIEW_TYPES } = require("@odoo_studio_community/studio_service");

var ActionEditor = Widget.extend({
    template: 'odoo_studio_community.ActionEditor',
    custom_events: {
    ...
    start: function () {
        ...
        _.each(ordered_view_types, function (view_type) {
            ...
            if (category) {
                view.appendTo(
                    self.$('.o_odoo_studio_community_view_category[name=' + category + ']')
                );
            }
        });
