odoo.define('odoo_studio_community.NewButtonBoxDialog', function (require) {
"use strict";
...
var NewButtonBoxDialog = Dialog.extend(StandaloneFieldManagerMixin, {
    template: 'odoo_studio_community.NewButtonBoxDialog',
    events: {
        'click .o_odoo_studio_community_icon_selector': '_on_IconSelector',
    },
    /**
     * @override
     */
