odoo.define('odoo_studio_community.FormEditorHook', function (require) {
"use strict";

var Widget = require('web.Widget');

var FormEditorHook = Widget.extend({
    className: 'o_odoo_studio_community_hook',
    /**
     * @constructor
     * @param {Widget} parent
    ...
    _renderSpan: function () {
        return $('<span>').addClass('o_odoo_studio_community_hook_separator');
    },
});
