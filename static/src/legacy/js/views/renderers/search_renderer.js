odoo.define('odoo_studio_community.SearchRenderer', function (require) {
"use strict";
...
var SearchRenderer = Widget.extend({
    ...
    _render: function () {
        ...
        this.defs = [];
        this.$el.empty();
        this.$el.html(qweb.render('odoo_studio_community.searchRenderer', this.widget));
    ...
    _renderFilter: function (node) {
        var $tbody = this.$('.o_odoo_studio_community_search_filters tbody');
    ...
    _renderGroupBy: function (node) {
        var $tbody = this.$('.o_odoo_studio_community_search_group_by tbody');
    ...
    _renderSeparator: function () {
        var $tbody = this.$('.o_odoo_studio_community_search_filters tbody');
        var $new_row = $('<tr class="o_odoo_studio_community_separator">').html('<td><hr/></td>');
