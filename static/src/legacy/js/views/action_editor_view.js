odoo.define('odoo_studio_community.ActionEditorView', function (require) {
"use strict";
...
var ActionEditorView = Widget.extend({
    template: 'odoo_studio_community.ActionEditorView',
    events: {
        'click .dropdown-item': '_onMenu',
        'click .o_odoo_studio_community_thumbnail': '_onThumbnail',
    },
    /**
     * @constructor
     * @param {Object} flags
