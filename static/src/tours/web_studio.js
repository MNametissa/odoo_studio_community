...
import utils from "odoo_studio_community.utils";
import tour from "web_tour.tour";

tour.register(
    "odoo_studio_community_home_menu_background_tour",
    {
        url: "/web",
        sequence: 260,
    },
    [
        ...
        {
            trigger:
                ".o_odoo_studio_community_home_studio_menu .dropdown-menu .dropdown-item.o_odoo_studio_community_change_background",
...
tour.register(
    "odoo_studio_community_new_app_tour",
    {
    ...
    [
        ...
        {
            trigger: ".o_odoo_studio_community_selectors .o_odoo_studio_community_selector:eq(2)",
        ...
        {
            trigger:
                ".o_odoo_studio_community_sidebar .o_odoo_studio_community_field_type_container:eq(1) .o_odoo_studio_community_field_char",
            content: _t(
        ...
        {
            trigger: ".o_odoo_studio_community_form_view_editor .o_wrap_label label",
        ...
        },
        {
            ...
            extra_trigger: ".o_odoo_studio_community_form_view_editor .o_wrap_label label:contains(My Field)",
        ...
        {
            trigger:
                ".o_odoo_studio_community_sidebar .o_odoo_studio_community_field_type_container:eq(1) .o_odoo_studio_community_field_selection",
            content: _t(
        ...
        {
            trigger: ".o_odoo_studio_community_field_dialog_form > .o_odoo_studio_community_add_selection input",
            content: _t(
        ...
        {
            trigger:
                ".o_odoo_studio_community_field_dialog_form > .o_odoo_studio_community_add_selection .o_odoo_studio_community_add_selection_value",
            auto: true,
        },
        {
        ...
        {
            trigger: ".o_odoo_studio_community_sidebar_text",
            auto: true,
        },
        {
            trigger: ".o_odoo_studio_community_form_view_editor .o_Chatter",
        ...
        {
            trigger: '.o_odoo_studio_community_sidebar .o_display_chatter input[name="email_alias"]',
            content: _t(
        ...
        {
            trigger: ".o_odoo_studio_community_menu .o_menu_sections li:contains(Views)",
            content: _t("Want more fun? Let’s create more <b>views</b>."),
            position: "bottom",
        },
        {
            trigger:
                '.o_odoo_studio_community_view_category .o_odoo_studio_community_view_type.o_odoo_studio_community_inactive[data-type="kanban"] .o_odoo_studio_community_thumbnail',
