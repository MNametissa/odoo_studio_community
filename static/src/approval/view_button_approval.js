...
import { StudioApproval } from "@odoo_studio_community/approval/studio_approval";
import { useApproval } from "@odoo_studio_community/approval/approval_hook";

patch(ViewCompiler.prototype, "odoo_studio_community.ViewCompilerApproval", {
...
patch(ViewButton.prototype, "odoo_studio_community.ViewButtonApproval", {
    setup() {
