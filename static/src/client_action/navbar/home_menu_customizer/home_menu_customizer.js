...
export class HomeMenuCustomizer extends Component {
    ...
    setBackgroundImage(attachment_id) {
        return this.rpc("/odoo_studio_community/set_background_image", {
     ...
     */
    exportCusto() {
        download({ url: "/odoo_studio_community/export", data: {} });
    }
    /**
    ...
    async confirmReset() {
        this.ui.block();
        try {
            await this.rpc("/odoo_studio_community/reset_background_image", {
                context: this.user.context,
            });
...
HomeMenuCustomizer.template = "odoo_studio_community.HomeMenuCustomizer";
