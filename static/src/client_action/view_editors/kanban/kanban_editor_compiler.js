...
export class KanbanEditorCompiler extends KanbanCompiler {
        ...
        compiled.querySelectorAll(".oe_kanban_avatar").forEach((el) => {
            ...
            if (tIf) {
                const tElse = createElement("t", {
                    "t-else": "",
                    "t-call": "odoo_studio_community.KanbanEditorRecord.AvatarPlaceholder",
                });
        ...
        if (nodeType === 1 && compiled) {
            ...
            if (node.hasAttribute("studioXpath")) {
                ...
                if (node.tagName === "field" && !isComponentNode(compiled)) {
                    ...
                    // Set empty class
                    const tattfClassEmpty = `{{ ${isEmptyExpr} ? "o_odoo_studio_community_widget_empty" : "" }}`;
    ...
    addTagsWidgetHook(compiled) {
        ...
        const tagsHook = createElement("span", {
            class: "o_odoo_studio_community_add_kanban_tags",
    ...
    addDropdownHook(compiled) {
        ...
        const dropdownHook = createElement(
            ...
            {
                class: "o_odoo_studio_community_add_dropdown o_dropdown_kanban dropdown",
                style: "z-index: 1;",
    ...
    addPriorityHook(compiled) {
        ...
        const priorityHook = createElement("div", {
            class: "o_odoo_studio_community_add_priority oe_kanban_bottom_left align-self-start flex-grow-0",
            style: "z-index: 1;",
    ...
    addAvatarHook(compiled) {
        ...
        const avatarHook = createElement("div", {
            class: "o_odoo_studio_community_add_kanban_image oe_kanban_bottom_right pe-auto",
            style: "z-index: 1;",
