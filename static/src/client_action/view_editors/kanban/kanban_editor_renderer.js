...
import { KanbanEditorRecord } from "@odoo_studio_community/client_action/view_editors/kanban/kanban_editor_record";
import {
    ...
    setup() {
        ...
        useEffect(
            (el) => {
                ...
                el.classList.add("o_odoo_studio_community_kanban_view_editor");
...
KanbanEditorRenderer.template = "odoo_studio_community.KanbanEditorRenderer";
