...
const colNearestHookClass = "o_odoo_studio_community_nearest_hook";
...
export class ListEditorRenderer extends listView.Renderer {
    setup() {
        ...
        useEffect(
            (rootEl) => {
                rootEl.classList.add("o_odoo_studio_community_list_view_editor");
        ...
        const highlightNearestHook = (draggedEl, { x, y }) => {
            ...
            columnsStyling(
                this.tableRef.el,
                `.o_odoo_studio_community_hook[data-xpath='${xpath}'][data-position='${position}']`,
                [colNearestHookClass]
            );
            return true;
        };
    ...
    onTableHover(ev) {
        ...
        columnsStyling(table, `[data-studio-xpath='${xpath}']:not(.o_odoo_studio_community_hook)`, [
            colHoverClass,
        ]);
    }
...
ListEditorRenderer.template = "odoo_studio_community.ListEditorRenderer";
ListEditorRenderer.recordRowTemplate = "odoo_studio_community.ListEditorRenderer.RecordRow";
