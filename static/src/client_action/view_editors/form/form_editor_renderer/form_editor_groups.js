...
import { studioIsVisible } from "@odoo_studio_community/client_action/view_editors/utils";
    ...
    class Group extends GroupClass {
        get allClasses() {
            ...
            if (!studioIsVisible(this.props)) {
                classes = `${classes || ""} o_odoo_studio_community_show_invisible`;
            }
        ...
        useEffect(
            (studioIsVisible, labelEl, fieldEl) => {
                ...
                if (labelEl) {
                    ...
                    const invisible = labelEl.querySelector(".o_odoo_studio_community_show_invisible");
                    if (invisible) {
                        invisible.classList.remove("o_odoo_studio_community_show_invisible");
                    }
                    labelEl.classList.toggle("o_odoo_studio_community_show_invisible", !studioIsVisible);
                ...
                if (fieldEl) {
                    ...
                    const invisible = fieldEl.querySelector(".o_odoo_studio_community_show_invisible");
                    if (invisible) {
                        invisible.classList.remove("o_odoo_studio_community_show_invisible");
                    }
...
InnerGroupItemComponent.template = "odoo_studio_community.Form.InnerGroup.ItemComponent";
...
InnerGroup.template = "odoo_studio_community.Form.InnerGroup";

// Simple override for OuterGroups
export const OuterGroup = extendGroup(components.OuterGroup);
OuterGroup.template = "odoo_studio_community.Form.OuterGroup";
