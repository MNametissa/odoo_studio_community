...
const formGrid = xml`
    <div class="o_odoo_studio_community_hook"
        ...
        t-att-data-type="props.type">
            <span class="o_odoo_studio_community_hook_separator" />
    </div>
`;

const kanbanRecord = xml`
    <span class="o_odoo_studio_community_hook"
        t-att-data-xpath="props.xpath"
        t-att-data-position="props.position"
        t-att-data-type="props.type" />
`;
...
<div class="o_odoo_studio_community_hook" t-att-data-xpath="props.xpath" t-att-data-position="props.position" t-att-data-type="props.type">
    <span class="o_odoo_studio_community_hook_separator" />
</div>
`;
