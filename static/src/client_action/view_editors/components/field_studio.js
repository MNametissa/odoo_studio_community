...
export class FieldStudio extends Field {
    ...
    get classNames() {
        ...
        classNames["o_odoo_studio_community_show_invisible"] = !studioIsVisible(this.props);
        ...
        if (this.studioIsEmpty()) {
            ...
            classNames["o_odoo_studio_community_widget_empty"] = true;
        }
        return classNames;
    }
    ...
    onClick(ev) {
        if (ev.target.classList.contains("o_odoo_studio_community_editX2Many")) {
            return;
        }
        ev.stopPropagation();
        ev.preventDefault();
...
FieldStudio.template = "odoo_studio_community.Field";
