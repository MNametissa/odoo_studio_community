/** @odoo-module **/
import { COLORS, BG_COLORS, ICONS } from "@odoo_studio_community/utils";
 ...
 * of colors and icon symbols (@see odoo_studio_community.utils for the full list of colors
 * and icon classes).
 * @extends Component
 */
...
IconCreator.template = "odoo_studio_community.IconCreator";
