odoo.define('odoo_studio_community.testUtils', function (require) {
"use strict";
...
var ReportEditorManager = require('odoo_studio_community.ReportEditorManager');
var ReportEditorSidebar = require('odoo_studio_community.ReportEditorSidebar');
var ViewEditorManager = require('odoo_studio_community.ViewEditorManager');
...
async function createReportEditor(params) {
        ...
        start: function () {
            ...
            this._super.apply(this, arguments).then(function () {
                var $studio = $.parseHTML(
                    "<div class='o_odoo_studio_community_client_action'>" +
                            "<div class='o_odoo_studio_community_editor_manager o_odoo_studio_community_report_editor_manager'/>" +
                        "</div>" +
                    "</div>");
    ...
    return parent.appendTo(selector).then(function () {
        ...
        return editor.appendTo(parent.$('.o_odoo_studio_community_editor_manager')).then(function () {
            return editor;
        });
    });
}
...
async function createReportEditorManager(params) {
    ...
    dom.append(parent.$('.o_odoo_studio_community_client_action'), fragment, {
...
async function createSidebar(params) {
    ...
    return sidebar.appendTo(fragment).then(function () {
        sidebar.$el.appendTo(parent.$('.o_odoo_studio_community_editor_manager'));
        return sidebar;
    });
}
