odoo.define('odoo_studio_community.form_tests', function (require) {
    'use strict';

    const FormView = require('web.FormView');
    const testUtils = require('web.test_utils');
    require('odoo_studio_community.FormRenderer');
    require('odoo_studio_community.FormController');
    ...
    QUnit.module(
        ...
        function () {
            ...
            QUnit.test('approval widget basic rendering', async function (assert) {
                ...
                assert.containsOnce(form, 'button[name="someMethod"] .o_odoo_studio_community_approval');
                assert.containsOnce(form, '#visibleStat .o_odoo_studio_community_approval');
                assert.containsNone(form, '#invisibleStat .o_odoo_studio_community_approval');
                assert.containsOnce(form, 'button[name="anotherMethod"] .o_odoo_studio_community_approval');
                assert.containsNone(form, '.o_group .o_odoo_studio_community_approval');
                ...
                // display popover
                await testUtils.dom.click('button[name="someMethod"] .o_odoo_studio_community_approval');
