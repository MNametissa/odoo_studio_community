odoo.define('odoo_studio_community.ReportEditorAction_tests', function (require) {
    "use strict";
    ...
    const { openStudio, registerStudioDependencies,getReportServerData } = require("@odoo_studio_community/../tests/helpers");
    ...
    QUnit.module('Studio', {
        ...
        QUnit.test('use pager', async function (assert) {
            ...
            const mockRPC = (route, args) => {
                switch (route) {
                    case "/odoo_studio_community/get_report_views":
                        return { report_html: reportHTML };
                    case "/odoo_studio_community/get_widgets_available_options":
                    case "/odoo_studio_community/read_paperformat":
                        return {};
                }
            };
