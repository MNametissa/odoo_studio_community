odoo.define('odoo_studio_community.NewModeltests', function (require) {
"use strict";

const NewModel = require('odoo_studio_community.NewModel');
    ...
    QUnit.test('Add New Model', async function (assert) {
        ...
        testUtils.mock.addMockEnvironment(newModel, {
            mockRPC: function (route, args) {
                if (route === "/odoo_studio_community/create_new_menu") {
        ...
        assert.containsNone($, '.o_odoo_studio_community_new_model_modal',
        ...
        assert.containsOnce($, '.o_odoo_studio_community_new_model_modal',
        ...
        const $configuratorModal = $('.o_odoo_studio_community_model_configurator');
        ...
        await testUtils.dom.click($configuratorModal.find('.o_odoo_studio_community_model_configurator_next'));
