...
QUnit.module("Studio Approval", (hooks) => {
    ...
    QUnit.test("approval components are synchronous", async (assert) => {
        ...
        assert.containsOnce(target, "button .o_odoo_studio_community_approval .fa-circle-o-notch.fa-spin");
        prom.resolve();
        await nextTick();
        assert.containsNone(target, "button .o_odoo_studio_community_approval .fa-circle-o-notch.fa-spin");
        assert.containsOnce(target, "button .o_odoo_studio_community_approval .o_odoo_studio_community_approval_avatar");
    });
    ...
    QUnit.test("approval widget basic rendering", async function (assert) {
        ...
        assert.containsOnce(target, 'button[name="someMethod"] .o_odoo_studio_community_approval');
        assert.containsOnce(target, "#visibleStat .o_odoo_studio_community_approval");
        assert.containsNone(target, "#invisibleStat .o_odoo_studio_community_approval");
        assert.containsOnce(target, 'button[name="anotherMethod"] .o_odoo_studio_community_approval');
        assert.containsNone(target, ".o_group .o_odoo_studio_community_approval");
        ...
        // display popover
        await click(target, 'button[name="someMethod"] .o_odoo_studio_community_approval');
        assert.containsOnce(target, ".o-approval-popover");
        const popover = target.querySelector(".o-approval-popover");
        assert.containsOnce(popover, ".o_odoo_studio_community_approval_no_entry");
    ...
    QUnit.test("approval continues to sync after a component has been destroyed", async function (assert) {
        ...
        await click(target, 'button[name="someMethod"]');
        assert.containsNone(target, 'button[name="otherMethod"] .o_odoo_studio_community_approval .fa-circle-o-notch.fa-spin');
        assert.containsOnce(target, 'button[name="otherMethod"] .o_odoo_studio_community_approval .o_odoo_studio_community_approval_avatar');
    });
});
