...
patch(MockServer.prototype, "odoo_studio_community.MockServer", {
    performRPC(route, args) {
        if (route === "/odoo_studio_community/activity_allowed") {
            return Promise.resolve(this.mockActivityAllowed());
        }
        if (route === "/odoo_studio_community/get_studio_view_arch") {
        ...
        if (route === "/odoo_studio_community/get_studio_action") {
