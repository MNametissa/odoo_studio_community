...
from odoo.addons.odoo_studio_community.controllers import main
from odoo.exceptions import ValidationError, UserError


class WebStudioReportController(main.WebStudioController):

    @http.route('/odoo_studio_community/create_new_report', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/print_report', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/edit_report', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/read_paperformat', type='json', auth='user')
    def read_paperformat(self, report_id):
        report = request.env['ir.actions.report'].browse(report_id)
        return report.get_paperformat().read()

    @http.route('/odoo_studio_community/get_widgets_available_options', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/get_report_views', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/edit_report_view', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/edit_report_view_arch', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/edit_report/test_load_assets', type='json', auth='user')
