...
from odoo.addons.odoo_studio_community.controllers import export
...
class WebStudioController(http.Controller):
    ...
    @http.route('/odoo_studio_community/chatter_allowed', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/activity_allowed', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/get_studio_action', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/create_new_app', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/create_new_menu', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/edit_menu_icon', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/set_background_image', type='json', auth='user')
    def set_background_image(self, attachment_id):
        attachment = request.env['ir.attachment'].browse(attachment_id)
        if attachment:
            request.env.company.background_image = attachment.datas

    @http.route('/odoo_studio_community/reset_background_image', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/add_view_type', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/edit_action', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/get_studio_view_arch', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/restore_default_view', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/edit_approval', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/rename_field', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/edit_field', type='json', auth='user')
...
Are you sure you want to remove the selection values of those records?""") % len(records)
    ...
    @http.route('/odoo_studio_community/edit_view_arch', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/export', type='http', auth='user')
    def export(self, **kw):
    ...
    @http.route('/odoo_studio_community/create_default_view', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/get_email_alias', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/set_email_alias', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/get_default_value', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/set_default_value', type='json', auth='user')
    ...
    @http.route('/odoo_studio_community/create_inline_view', type='json', auth='user')
