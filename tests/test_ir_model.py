...
from odoo.addons.odoo_studio_community.controllers.export import MODELS_TO_EXPORT, FIELDS_TO_EXPORT, \
     FIELDS_NOT_TO_EXPORT, CDATA_FIELDS, XML_FIELDS
from odoo.addons.odoo_studio_community.models.ir_model import OPTIONS_WL
