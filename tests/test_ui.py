...
from odoo.addons.odoo_studio_community.controllers.main import WebStudioController
...
class TestUi(odoo.tests.HttpCase):
    ...
    def test_new_app_and_report(self):
        self.start_tour("/web", 'odoo_studio_community_new_app_tour', login="admin")

        # the report tour is based on the result of the former tour
        self.start_tour("/web?debug=tests", 'odoo_studio_community_new_report_tour', login="admin")
        self.start_tour("/web?debug=tests", "odoo_studio_community_new_report_basic_layout_tour", login="admin")

    def test_optional_fields(self):
        self.start_tour("/web?debug=tests", 'odoo_studio_community_hide_fields_tour', login="admin")

    def test_model_option_value(self):
        self.start_tour("/web?debug=tests", 'odoo_studio_community_model_option_value_tour', login="admin")

    def test_rename(self):
        self.start_tour("/web?debug=tests", 'odoo_studio_community_tests_tour', login="admin", timeout=200)

    def test_approval(self):
        self.start_tour("/web?debug=tests", 'odoo_studio_community_approval_tour', login="admin")
    ...
    def test_background(self):
        ...
        self.start_tour("/web?debug=tests", 'odoo_studio_community_custom_background_tour', login="admin")
    ...
    def test_create_app_with_pipeline_and_user_assignment(self):
        ...
        self.start_tour("/web?debug=tests", 'odoo_studio_community_create_app_with_pipeline_and_user_assignment', login="admin")
    ...
    def test_alter_field_existing_in_multiple_views(self):
        ...
        self.start_tour("/web?debug=tests", 'odoo_studio_community_alter_field_existing_in_multiple_views_tour', login="admin")
    ...
    def test_hide_page_of_notebook(self):
        self.start_tour("/web?debug=tests", 'odoo_studio_community_test_hide_page_of_notebook', login="admin")
...
def watch_edit_view(test, on_edit_view):
    ...
    @http.route('/odoo_studio_community/edit_view', type='json', auth='user')
...
class TestStudioUIUnit(odoo.tests.HttpCase):
    ...
    def test_form_view_not_altered_by_studio_xml_edition(self):
        self.start_tour("/web?debug=tests", 'odoo_studio_community_test_form_view_not_altered_by_studio_xml_edition', login="admin", timeout=200)
    ...
    def test_edit_with_xml_editor(self):
        ...
        self.start_tour("/web?debug=tests", 'odoo_studio_community_test_edit_with_xml_editor', login="admin", timeout=200)
    ...
    def test_enter_x2many_edition_and_add_field(self):
        ...
        self.start_tour("/web?debug=tests", 'odoo_studio_community_enter_x2many_edition_and_add_field', login="admin", timeout=200)
        studioView = _get_studio_view(self.testView)
    ...
    def test_enter_x2many_auto_inlined_subview(self):
        ...
        self.start_tour("/web?debug=tests", 'odoo_studio_community_enter_x2many_auto_inlined_subview', login="admin", timeout=200)
        studioView = _get_studio_view(self.testView)
    ...
    def test_enter_x2many_auto_inlined_subview_with_multiple_field_matching(self):
        ...
        self.start_tour("/web?debug=tests", 'odoo_studio_community_enter_x2many_auto_inlined_subview_with_multiple_field_matching',
    ...
    def test_field_with_group(self):
        ...
        self.start_tour("/web?debug=tests", 'odoo_studio_community_field_with_group', login="admin", timeout=200)
    ...
    def test_elements_with_groups_form(self):
        ...
        self.start_tour("/web", 'odoo_studio_community_elements_with_groups_form', login="admin", timeout=600000)
        self.assertEqual(len(operations), 1)
    ...
    def test_create_one2many_lines_then_edit_name(self):
        ...
        self.start_tour("/web?debug=tests", 'odoo_studio_community_test_create_one2many_lines_then_edit_name', login="admin", timeout=30000)
    ...
    def test_address_view_id_no_edit(self):
        ...
        self.start_tour("/web?debug=tests", 'odoo_studio_community_test_address_view_id_no_edit', login="admin", timeout=200)
    ...
    def test_custom_selection_field_edit_values(self):
        ...
        self.start_tour("/web?debug=tests", 'odoo_studio_community_custom_selection_field_edit_values', login="admin", timeout=200)
    ...
    def test_create_new_model_from_existing_view(self):
        ...
        self.start_tour("/web?debug=tests", 'odoo_studio_community_test_create_new_model_from_existing_view', login="admin",
                        timeout=200)
    ...
    def test_create_model_with_clickable_stages(self):
        ...
        self.patch(type(self.env["base"]), "web_read_group", muted_web_read_group)
        self.start_tour("/web?debug=tests", 'odoo_studio_community_test_create_model_with_clickable_stages', login="admin", timeout=200)
    ...
    def test_enter_x2many_edition_with_multiple_subviews(self):
        ...
        '''.format(doesnothavegroup=doesNotHaveGroupXmlId.complete_name, hasgroup=hasGroupXmlId.complete_name)
        self.start_tour("/web?debug=tests", 'odoo_studio_community_test_enter_x2many_edition_with_multiple_subviews',
                        login="admin", timeout=200)
    ...
    def test_enter_x2many_edition_with_multiple_subviews_correct_xpath(self):
        ...
        '''.format(doesnothavegroup=doesNotHaveGroupXmlId.complete_name, hasgroup=hasGroupXmlId.complete_name)
        self.start_tour("/web?debug=tests", 'odoo_studio_community_test_enter_x2many_edition_with_multiple_subviews_correct_xpath',
                        login="admin", timeout=200)
        studioView = _get_studio_view(self.testView)
        assertViewArchEqual(self, studioView.arch, """
            <data>
    ...
    def test_studio_view_is_last(self):
        ...
        self.start_tour("/web?debug=tests", 'odoo_studio_community_test_studio_view_is_last', login="admin", timeout=200)
        studioView = _get_studio_view(self.testView)
    ...
    def test_edit_form_subview_attributes(self):
        ...
        self.start_tour("/web?debug=tests", 'odoo_studio_community_test_edit_form_subview_attributes', login="admin",
                        timeout=200)
    ...
    def test_move_similar_field(self):
        ...
        self.start_tour("/web?debug=tests", 'odoo_studio_community_test_move_similar_field', login="admin", timeout=400)
    ...
    def test_related_binary_field_with_filename(self):
        ...
        self.start_tour("/web?debug=tests", 'odoo_studio_community_test_related_file', login="admin", timeout=400)
