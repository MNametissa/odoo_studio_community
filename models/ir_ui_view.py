...
class View(models.Model):
    ...
    def create_automatic_views(self, res_model):
        ...
        Note: This version is modified for Community Edition.
        Gantt and Map views are disabled (require web_gantt and web_map modules).
        """
        ...
        # gantt: DISABLED - requires web_gantt module (Enterprise only)
        ...
        # map: DISABLED - requires web_map module (Enterprise only)
